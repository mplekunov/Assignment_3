...
public class Main {
    public static void main(String[] args) throws IOException {
        var fileIn = new File(Paths.get("").toAbsolutePath().toString().concat("\\resources\\main\\ex45\\"), "exercise45_input.txt");
        var matcher = new File(Paths.get("").toAbsolutePath().toString().concat("\\resources\\main\\ex45\\"), "pattern.txt");
        ...
        File fileOut = new File(Paths.get("").toAbsolutePath().toString().concat("\\resources\\main\\ex45\\"), outputFileName);
